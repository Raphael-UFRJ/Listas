# 1-Um casco de navio consiste de 562 placas met ??alicas que devem ser rebitadas.
...
#   1. Crie um modelo de risco de custo de m ??ao-obra de rebitagem usando MC
#   2. Compare a distribui ??c ??ao cumulativa obtida usando a abordagem MC com aquela obtida usando o TCL.
...
q1 <- function(n) {
  ...
  hist(custo_total, breaks = "FD", xlab = "Custo Total de M??o-de-Obra", main = "Histograma do Custo Total de M??o-de-Obra")
}
